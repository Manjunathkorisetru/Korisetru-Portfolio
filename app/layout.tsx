...
export const metadata = {
  title: "Manjunath | Personal Portfolio",
  description: "Manjunath Korisetru is a Software Engineer based in Germany.",
};
  ...
  return (
    <html lang="en">
      ...
      >
        ...
        ></div>
        <div
          className="bg-[#dbd7fb] absolute top-[-1rem] left-[-35rem] h-[31.25rem] 
        w-[50rem] -z-10 rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] 
        lg:left-[-26rem] xl:left-[-15rem] 2xl:left[-5rem]"
        ></div>
