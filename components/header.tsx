  ...
  return (
    <header className="z-[999] relative">
      ...
      >
        ...
        gap-y-1 text-[0.9rem] font-medium text-gray-100 sm:w-[initial] sm:flex-nowrap sm:gap-5"
        >
          {links.map((link) => (
            <motion.li
            ...
            >
              <Link
                className={clsx(
                  "flex w-full items-center justify-center px-3 py-3 transition text-black ",
                  {
              ...
              >
                ...
                {link.name === activeSection && (
                  <motion.span
                    className="bg-gray-100 rounded-full absolute inset-0 -z-10 text-black"
