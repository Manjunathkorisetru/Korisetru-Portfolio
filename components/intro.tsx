...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Manjunath.</span> I'm a{" "}
        <span className="font-bold">Software Engineer</span> with{" "}
        <span className="font-bold">2 years</span> of experience in Software
      ...
      >
        <Link
          ...
          hover:scale-105 hover:bg-gray-950 transition"
          //   onClick={() => {
        ...
        <a
          ...
          rounded-full outline-none focus:scale-105 hover:scale-110 
          transition cursor-pointer borderBlack"
          href="/Manjunath_Korisetru_CV.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          rounded-full focus:scale-[1.15] hover:scale-[1.15] transition 
          cursor-pointer borderBlack"
          href="https://www.linkedin.com/in/manjunath-korisetru/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
         ...
         transition cursor-pointer borderBlack"
          href="https://github.com/Manjunathkorisetru"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
